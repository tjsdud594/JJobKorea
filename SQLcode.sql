...
insert all
     ...
     into Company values(08, 'Cizen', 'Medical', 'Genetic_Algorithm', 3897, 1, 'medium', 'experience')
     into Company values(09, 'Vuno', 'Medical', 'Image', 3682, 1, 'medium', 'experience')
     into Company values(10, 'ADT Caps', 'Security', 'Cloud_Security', 3016, 1, 'big', 'experience')
     into Company values(11, 'Ahn Lab', 'Security', 'Anti_Virus', 3000, 1, 'medium', 'experience')
     into Company values(12, 'Secui', 'Security', 'Cloud_Security', 5416, 1, 'big', 'newcomer')
     into Company values(13, 'Naver', 'IT_Service', 'Platform', 4500, 2, 'big', 'newcomer')
     into Company values(14, 'KaKao', 'IT_Service', 'Applications', 4200, 2, 'big', 'newcomer')
     into Company values(15, 'Google Korea', 'IT_Service', 'Platform', 4055, 2, 'big', 'newcomer')
select * from dual;
commit;
